...
* https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes["가상 머신 확장 세트에 대한 Cloud Volumes ONTAP 지원에 대해 알아보십시오"^]
...
이 릴리스에는 사소한 개선 사항, 버그 수정 및 새로운 Azure 권한 요구 사항이 포함되어 있습니다.
...
==== Azure 기반 Flash Cache에 대해 지원되는 최소 ONTAP 버전

Azure에서 Flash Cache를 구성하는 데 필요한 최소 ONTAP 버전은 9.13.1 GA입니다. ONTAP 9.13.1 GA 이상 버전만 사용하여 Azure용 Cloud Volumes ONTAP 시스템에 Flash Cache를 구축할 수 있습니다.
