...
==== EC2 인스턴스에 대한 IMDSv1 요구 사항

AWS에 Connector 소프트웨어를 수동으로 설치하기 전에 Amazon EC2 인스턴스에서 IMDSv1(인스턴스 메타데이터 서비스 버전 1)이 필요하다는 것을 알고 있어야 합니다.

https://docs.netapp.com/us-en/bluexp-setup-admin/reference-limitations.html["AWS에서 IMDSv1의 요구 사항에 대해 자세히 알아보십시오"].
